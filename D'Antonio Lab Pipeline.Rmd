...
leaf_traits_summary <- merge(curling_summary, thickness_summary, mass_summary, by="species_cleaned") # create one data frame with the summary stats for each leaf trait (not)
```
